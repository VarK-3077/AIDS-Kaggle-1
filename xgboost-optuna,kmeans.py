...
# This is necessary for StandardScaler and KMeans to work correctly.
print("Handling missing values by filling with 0...")
X_train.fillna(0, inplace=True)
print("Data prepared.")
print("-" * 30)

# --- 4. Feature Engineering with K-Means Clustering ---
print("Applying StandardScaler and K-Means clustering...")
# K-Means is sensitive to feature scales, so we standardize the data first
scaler = StandardScaler()
X_scaled = scaler.fit_transform(X_train)

# Define and fit the KMeans model.
# The number of clusters (k) is a hyperparameter you can tune.
# We'll use k=5 as a reasonable starting point.
n_clusters = 7
...
print(f"Added {n_clusters} cluster labels as a new feature ('cluster').")
print("-" * 30)
...
print("✅ Success! The model has been evaluated with K-Means features.")
