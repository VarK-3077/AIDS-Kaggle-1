...
# --- 3. Build the FrankenBoost Model ---
print("Building the custom FrankenBoost model (with Optuna tuning)...")
# The get_model function now runs the tuning process
frankenboost_model = get_model(X_train, y_train)
print("Model built successfully.")
print("-" * 30)

# --- 4. Evaluate the Model with 10-Fold Cross-Validation ---
